    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-3xl font-bold text-[#202224] mb-8">Sign Up</h1>
              ...
              <Checkbox
                label={
                  <span className="text-sm text-[#8B8D97]">
                    ...
                    <Link to="/terms" className="text-[#5B5FFF] hover:underline">
                      terms of use
                    </Link>{' '}
                    and our{' '}
                    <Link to="/privacy" className="text-[#5B5FFF] hover:underline">
                      privacy policy
                    </Link>
                    .
                  </span>
          ...
          <p className="text-center text-sm text-[#8B8D97] mt-6">
            ...
            <Link to="/login" className="text-[#5B5FFF] hover:underline font-medium">
              Log in
            </Link>
          </p>
        </div>
